...
$LOCAL_LANG = Array (
	'default' => Array (
		...
		'tx_civserv_pi2_employee_list.hod_by_name' => 'HODS by names',
		...
		'tx_civserv_pi2_employee_list.orcode_hod' => 'HOD',
		'tx_civserv_pi2_employee_list.heading' => 'actual Filter: ###MODE###',
...
//		'tx_civserv_pi2_weekday_403' => '',
	...
	'de' => Array (
		...
		'tx_civserv_pi2_community_search_label' => 'Sie haben noch keine Kommune (Kreis, Stadt oder Gemeinde) ausgewählt. Bitte treffen Sie Ihre Auswahl.',
		'tx_civserv_pi2_debit_form.debit_form' => 'Ermächtigung zum Einzug von Forderungen mittels Lastschriften',
		'tx_civserv_pi2_debit_form.serviceName' => 'Name der Dienstleistung, für die die Lastschriftermächtigung erteilt wird',
		'tx_civserv_pi2_debit_form.serviceSelect' => 'Bitte wählen sie die Dienstleistung, für die die Lastschriftermächtigung erteilt werden soll',
		...
		'tx_civserv_pi2_debit_form.agreement' => 'Ich bin damit einverstanden, dass die von mir gemachten freiwilligen Angaben zum Zwecke der Aufgabenerfüllung der Stadtkasse gespeichert werden.',
		...
		'tx_civserv_pi2_debit_form.button_reset' => 'Eingaben löschen',
		'tx_civserv_pi2_debit_form.no_results' => 'UID für das Formular "Allgemeine Lastschriftermächtigung" ist in der Konfigurationstabelle nicht gesetzt!',
		'tx_civserv_pi2_debit_form.error_cashNumber' => 'Bitte geben Sie ein gültiges Kassenzeichen an!',
		'tx_civserv_pi2_debit_form.error_bankName' => 'Bitte geben Sie den Namen Ihres Bankinstitutes an!',
		'tx_civserv_pi2_debit_form.error_bankCode' => 'Bitte geben Sie eine gültige Bankleitzahl an!',
		'tx_civserv_pi2_debit_form.error_accountNumber' => 'Bitte geben Sie eine gültige Kontonummer an!',
		'tx_civserv_pi2_debit_form.error_email' => 'Bitte geben Sie eine gültige E-Mail-Adresse an!',
		...
		'tx_civserv_pi2_debit_form.error_service' => 'Für diese Dienstleistung wurde kein Lastschriftformular gefunden!',
		...
		'tx_civserv_pi2_email_form.notice' => 'Geben Sie bitte eine Postadresse, E-Mail-Adresse oder Telefon-/Faxnummer an, damit wir Ihnen eine Antwort zukommen lassen können.',
		'tx_civserv_pi2_email_form.title' => 'Anrede',
		'tx_civserv_pi2_email_form.chose' => 'Bitte wählen Sie',
		...
		'tx_civserv_pi2_email_form.street' => 'Straße, Hnr.',
		...
		'tx_civserv_pi2_email_form.reset' => 'Alle Angaben löschen',
		'tx_civserv_pi2_email_form.required' => 'Diese Felder müssen ausgefüllt werden.',
		...
		'tx_civserv_pi2_email_form.error_postcode' => 'Bitte geben Sie eine gültige Postleitzahl an!',
		...
		'tx_civserv_pi2_error.wrong_community_id' => 'Falsche Gemeindekennziffer. Die übergebene Gemeindekennziffer ist entweder ungültig oder das Virtuelle Rathaus der entsprechenden Gemeinde wird nicht in diesem System gepflegt. Diese Meldung weist in der Regel auf eine Fehlkonfiguration des Systems hin.',
		'tx_civserv_pi2_error.community_id_twice' => 'Die übergebene Gemeindekennziffer existiert mehr als einmal in der Konfigurationstabelle für dieses System. Diese Meldung weist auf eine Fehlkonfiguration des Systems hin.',
		'tx_civserv_pi2_error.invalid_mode' => 'Ungültiger mode',
		'tx_civserv_pi2_error.unknown_category' => 'Die ausgewählte Kategorie (Lebenslage, Nutzergruppe oder Organisation) ist unbekannt.)',
		'tx_civserv_pi2_error.unvalid_organisation' => 'Es wurde eine ungültige Organisations-ID übergeben.',
		'tx_civserv_pi2_error.folder' => 'Der Ordner für die Dateien der Kommunen wurde im Template nicht konfiguriert.',
		'tx_civserv_pi2_employee_list.by_name' => ' nach Namen',
		'tx_civserv_pi2_employee_list.em_by_name' => 'Mitarabeiter nach Namen',
		'tx_civserv_pi2_employee_list.hod_by_name' => 'Leiter nach Namen',
		'tx_civserv_pi2_employee_list.empossearch' => 'Mitarbeiter-Suche',
		'tx_civserv_pi2_employee_list.by_organisation' => 'Mitarbeiter nach Ämtern',
		'tx_civserv_pi2_employee_list.az' => 'Mitarbeiter(innen) A - Z',
		'tx_civserv_pi2_employee_list.orcode' => 'Mitarbeiter(innen) nach Ämter',
		'tx_civserv_pi2_employee_list.orcode_all' => 'alle',
		'tx_civserv_pi2_employee_list.orcode_hod' => 'Leiter/innen',
		'tx_civserv_pi2_employee_list.heading' => 'aktuelle Sortierung: ###MODE###', //will be replaced with em_by_name or with hod_by_name or with by_organisation
		'tx_civserv_pi2_employee_list.available_employees' => 'Folgende Mitarbeiter(innen) finden Sie hier',
		'tx_civserv_pi2_employee.backlink' => 'zurück zur Übersicht',
		'tx_civserv_pi2_form_list.form_list' => 'Formulare',
		'tx_civserv_pi2_form_list.overview' => 'Überblick',
		'tx_civserv_pi2_form_list.available_forms' => 'Folgende Formulare finden Sie hier',
		'tx_civserv_pi2_form_list.assigned_services' => 'Die folgenden Anliegen sind mit diesem Formular verknüpft',
		'tx_civserv_pi2_form_list.name' => 'Formularname',
		'tx_civserv_pi2_form_list.description' => 'Formularbeschreibung',
		#'tx_civserv_pi2_organisation_list.organisation_list' => 'Ämter, Einrichtungen, Kundenzentren', //modification
		'tx_civserv_pi2_organisation_list.organisation_list' => 'Organisation', //modification
		#'tx_civserv_pi2_organisation_list.organisation_list.heading' => 'Städtische Ämter, Einrichtungen und Kundenzentren von A - Z',	//modification
		...
		#'tx_civserv_pi2_menuarray.service_list' => 'Zuständigkeiten A - Z', //modification
		...
		#'tx_civserv_pi2_menuarray.organisation_list' => 'Ämter, Einrichtungen, Kundenzentren', //modification
		...
		#'tx_civserv_pi2_menuarray.form_list' => 'Formulare im Überblick',	//modification
		...
		'tx_civserv_pi2_organisation.pub_trans_info' => 'ÖPNV-Information',
		...
		#'tx_civserv_pi2_organisation.organisation_tree.heading' => 'Organisationsstruktur der Ämter, Einrichtungen und Kundenzentren in %s', //modification
		...
		'tx_civserv_pi2_organisation.backlink' => 'zurück zur Übersicht',
		...
		'tx_civserv_pi2_organisation.super_org_label' => 'übergeordnete Organisationseinheit:', //modification
		...
		'tx_civserv_pi2_search.empty_query' => 'Leere Abfrage! Sie müssen ein Wort angeben, nach dem Sie suchen wollen.',
		...
		#'tx_civserv_pi2_service.service' => 'Zuständigkeiten A-Z', // modification
		'tx_civserv_pi2_service.service' => 'Anliegen A-Z', // modification
		'tx_civserv_pi2_service.external_service' => 'Für diese Dienstleistung wenden Sie sich bitte an ',
		...
		'tx_civserv_pi2_service.description_long' => 'Ausführliche Beschreibung',
		'tx_civserv_pi2_service.error_valid' => 'Dienstleistung exisitert nicht oder ist nicht verfügbar.',
		'tx_civserv_pi2_service.image' => 'Bild',
		'tx_civserv_pi2_service.image_text' => 'Bildbeschreibung',
		'tx_civserv_pi2_service.fees' => 'Gebühren',
		'tx_civserv_pi2_service.documents' => 'Benötigte Unterlagen',
		...
		'tx_civserv_pi2_service.similar_services' => 'Ähnliche Anliegen',
		'tx_civserv_pi2_service.organisation' => 'Zuständige Organisationseinheit(en)',
		...
		'tx_civserv_pi2_service.pages_related_topics' => 'Seiten mit ähnlichen Themen',
		...
		'tx_civserv_pi2_common.frequently_visited' => 'Folgende Seiten wurden häufig aufgerufen',
		#'tx_civserv_pi2_service_list.service_list' => 'Zuständigkeiten A-Z', //modification
		...
		'tx_civserv_pi2_service_list.organisation' => 'Organisation',
		#'tx_civserv_pi2_service_list.overview' => 'Zuständigkeiten A-Z', //modification
		'tx_civserv_pi2_service_list.overview' => 'Überblick', //modification
		...
		'tx_civserv_pi2_top15.top15' => 'Die 15 am häufigsten nachgefragten Dienstleistungen',
		...
		'tx_civserv_pi2_weekday_401' => 'zusätzlich',
