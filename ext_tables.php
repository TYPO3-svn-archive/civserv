...
$TCA["tx_civserv_organisation"] = Array (
	...
	"feInterface" => Array (
		"fe_admin_fieldList" => "hidden, fe_group, or_number, or_code, or_name, or_hours, or_telephone, or_fax, or_email, or_image, or_infopage, or_addinfo, or_structure, or_building",
	)
);
