...
*
* @author Tobias M&uuml;ller (mullerto@uni-muenster.de),
...
$LOCAL_LANG = Array (
    'default' => Array (
            ...
            'tx_civserv_wizard_service_form.warning_msg_2' => 'Error - reference to main window is not set properly!',
				// LOCAL_LANG for class.tx_civserv_wizard_service_form_category.php
            'tx_civserv_wizard_service_form_category.title' => 'Select formulars by categories',
            'tx_civserv_wizard_service_form_category.select_category_text' => 'Select beginning letter of formular',
			'tx_civserv_wizard_service_form_category.select_form_text' => 'Select formulars beginning with ',
			'tx_civserv_wizard_service_form_category.form_category_dummy' => 'Bitte w&auml;hle sie eine Kategorie aus',
			'tx_civserv_wizard_service_form_category.select_formulars_text_no_abc' => 'Select formulars',
            'tx_civserv_wizard_service_form_category.letter' => 'Letter',
            'tx_civserv_wizard_service_form_category.formulars' => 'Formulars',
            'tx_civserv_wizard_service_form_category.OK_Button' => 'OK',
            'tx_civserv_wizard_service_form_category.Cancel_Button' => 'Cancel',
			'tx_civserv_wizard_service_form_category.warning_no_category' => 'Sorry, no categories available,###br### ask the administrator',
            'tx_civserv_wizard_service_form_category.warning_msg_1' => 'Please choose at least one formular!',
            'tx_civserv_wizard_service_form_category.warning_msg_2' => 'Error - reference to main window is not set properly!',
			...
			'tx_civserv_wizard_employee_position_room.no_room_on_this_floor' => 'No room on this floor!',
        ...
        'de' => Array (
			...
			'all_wizards.search_warning' => 'Bitte geben Sie einen Suchbegriff ein !',
				// LOCAL_LANG for class.tx_civserv_wizard_employee_em_position.php
            'tx_civserv_wizard_employee_em_position.title' => 'W&auml;hlen Sie die Stellen des Mitarbeiters',
            'tx_civserv_wizard_employee_em_position.select_letter_text' => 'Anfangsbuchstaben der Stellenbezeichnung w&auml;hlen',
            'tx_civserv_wizard_employee_em_position.select_positions_text' => 'Stellen w&auml;hlen mit Anfangsbuchstaben ',
			'tx_civserv_wizard_employee_em_position.select_positions_text_no_abc' => 'Stellen w&auml;hlen',
            ...
            'tx_civserv_wizard_employee_em_position.warning_msg_1' => 'Bitte w&auml;hlen Sie mindestens eine Position aus!',
            'tx_civserv_wizard_employee_em_position.warning_msg_2' => 'FEHLER - Referenz auf das Hauptfenster nicht richtig gesetzt!',
				// LOCAL_LANG for class.tx_civserv_wizard_modelservice.php
            'tx_civserv_wizard_modelservice.title' => 'W&auml;hlen Sie ein Musteranliegen',
            'tx_civserv_wizard_modelservice.select_category_text' => 'Kategorie w&auml;hlen',
            'tx_civserv_wizard_modelservice.select_model_service_text' => 'Musteranliegen w&auml;hlen',
            ...
            'tx_civserv_wizard_modelservice.model_service_category_dummy' => 'Kategorie w&auml;hlen',
            'tx_civserv_wizard_modelservice.model_service_dummy' => 'Musteranliegen w&auml;hlen',
            'tx_civserv_wizard_modelservice.OK_Button' => 'OK',
			...
			'tx_civserv_wizard_modelservice.save_message' => 'Bitte f&uuml;llen Sie das Feld "Name" auf der Dienstleistungs-Eingabemaske und speichern Sie dann die Dienstleistung. Danach k&ouml;nnen Sie die Dienstleistung weiter editieren (Die Felder, die durch das Musteranliegen gef&uuml;llt werden sind nunmehr ausgeblendet).',
            'tx_civserv_wizard_modelservice.warning_msg_1' => 'Bitte w&auml;hlen Sie ein Musteranliegen aus!',
            'tx_civserv_wizard_modelservice.warning_msg_2' => 'FEHLER - Referenz auf das Hauptfenster nicht richtig gesetzt!',
				// LOCAL_LANG for class.tx_civserv_wizard_organisation_supervisor.php
            'tx_civserv_wizard_organisation_supervisor.title' => 'W&auml;hlen Sie einen Leiter',
            'tx_civserv_wizard_organisation_supervisor.select_letter_text' => 'Anfangsbuchstaben des Nachnamens w&auml;hlen',
            'tx_civserv_wizard_organisation_supervisor.select_supervisor_text' => 'Leiter w&auml;hlen mit Anfangsbuchstaben ',
			'tx_civserv_wizard_organisation_supervisor.select_supervisor_text_no_abc' => 'Leiter w&auml;hlen',
            'tx_civserv_wizard_organisation_supervisor.letter' => 'Buchstabe',
            'tx_civserv_wizard_organisation_supervisor.supervisor' => 'Leiter',
            'tx_civserv_wizard_organisation_supervisor.supervisor_dummy' => 'Leiter w&auml;hlen',
            'tx_civserv_wizard_organisation_supervisor.OK_Button' => 'OK',
            'tx_civserv_wizard_organisation_supervisor.Cancel_Button' => 'Abbrechen',
            'tx_civserv_wizard_organisation_supervisor.warning_msg_1' => 'Bitte w&auml;hlen Sie einen Leiter aus!',
            'tx_civserv_wizard_organisation_supervisor.warning_msg_2' => 'FEHLER - Referenz auf das Hauptfenster nicht richtig gesetzt!',
				// LOCAL_LANG for class.tx_civserv_wizard_service_form.php
            'tx_civserv_wizard_service_form.title' => 'W&auml;hlen Sie die Formulare',
            'tx_civserv_wizard_service_form.select_letter_text' => 'Anfangsbuchstaben der Formularbezeichnung w&auml;hlen',
            'tx_civserv_wizard_service_form.select_formulars_text' => 'Formulare w&auml;hlen mit Anfangsbuchstaben ',
			'tx_civserv_wizard_service_form.select_formulars_text_no_abc' => 'Formulare w&auml;hlen',
            ...
            'tx_civserv_wizard_service_form.warning_msg_1' => 'Bitte w&auml;hlen Sie mindestens ein Formular aus!',
            'tx_civserv_wizard_service_form.warning_msg_2' => 'FEHLER - Referenz auf das Hauptfenster nicht richtig gesetzt!',
				// LOCAL_LANG for class.tx_civserv_wizard_service_form_category.php
            'tx_civserv_wizard_service_form_category.title' => 'W&auml;hlen Sie die Formulare nach ihrer Kategorie aus',
            'tx_civserv_wizard_service_form_category.select_category_text' => 'Anfangsbuchstaben der Kategorie w&auml;hlen',
            'tx_civserv_wizard_service_form_category.select_form_text' => 'Formulare w&auml;hlen mit Anfangsbuchstaben ',
			'tx_civserv_wizard_service_form_category.form_category_dummy' => 'Bitte w&auml;hle sie eine Kategorie aus',
			'tx_civserv_wizard_service_form_category.select_formulars_text_no_abc' => 'Formulare w&auml;hlen',
            'tx_civserv_wizard_service_form_category.letter' => 'Buchstabe',
            'tx_civserv_wizard_service_form_category.formulars' => 'Formulare',
            'tx_civserv_wizard_service_form_category.OK_Button' => 'OK',
            'tx_civserv_wizard_service_form_category.Cancel_Button' => 'Abbrechen',
			'tx_civserv_wizard_service_form_category.warning_no_category' => 'Es sind keine Kategorien definiert,###br###wenden Sie sich an den Adminstrator!',
            'tx_civserv_wizard_service_form_category.warning_msg_1' => 'Bitte w&auml;hlen Sie mindestens ein Formular aus!',
            'tx_civserv_wizard_service_form_category.warning_msg_2' => 'FEHLER - Referenz auf das Hauptfenster nicht richtig gesetzt!',
				// LOCAL_LANG for class.tx_civserv_wizard_service_position.php
            'tx_civserv_wizard_service_position.title' => 'W&auml;hlen Sie aus allen verf&uuml;gbaren Positionen &uuml;ber die Stellenbezeichnung',
            'tx_civserv_wizard_service_position.select_letter_text' => 'Anfangsbuchstaben der Stellenbezeichnung w&auml;hlen',
            'tx_civserv_wizard_service_position.select_positions_text' => 'Stellen w&auml;hlen mit Anfangsbuchstaben ',
			'tx_civserv_wizard_service_position.select_positions_text_no_abc' => 'Stellen w&auml;hlen',
            ...
            'tx_civserv_wizard_service_position.warning_msg_1' => 'Bitte w&auml;hlen Sie mindestens eine Stelle aus!',
            'tx_civserv_wizard_service_position.warning_msg_2' => 'FEHLER - Referenz auf das Hauptfenster nicht richtig gesetzt!',
				// LOCAL_LANG for class.tx_civserv_wizard_service_position_em_name.php
			'tx_civserv_wizard_service_position_em_name.title' => 'W&auml;hlen Sie aus allen verf&uuml;gbaren Position &uuml;ber den Namen des Mitarbeiters',
			'tx_civserv_wizard_service_position_em_name.select_letter_text' => 'Anfangsbuchstaben des Mitarbeiters w&auml;hlen',
			'tx_civserv_wizard_service_position_em_name.select_positions_text' => 'Mitarbeiter w&auml;hlen mit Anfangsbuchstaben ',
			'tx_civserv_wizard_service_position_em_name.select_positions_text_no_abc' => 'Mitarbeiter w&auml;hlen',
			...
			'tx_civserv_wizard_service_position_em_name.warning_msg_1' => 'Bitte w&auml;hlen Sie mindestens einen Mitarbeiter aus!',
			'tx_civserv_wizard_service_position_em_name.warning_msg_2' => 'FEHLER - Referenz auf das Hauptfenster nicht richtig gesetzt!',
				// LOCAL_LANG for class.tx_civserv_wizard_service_position_limited_sv_organisation.php
            'tx_civserv_wizard_service_position_limited_sv_organisation.title' => 'W&auml;hlen Sie aus den Positionen, die zu den in diese Maske eingetragenen Organistionen geh&ouml;ren',
            'tx_civserv_wizard_service_position_limited_sv_organisation.select_letter_text' => 'Anfangsbuchstaben der Stellenbezeichnung w&auml;hlen',
            'tx_civserv_wizard_service_position_limited_sv_organisation.select_positions_text' => 'Stellen w&auml;hlen mit Anfangsbuchstaben ',
			'tx_civserv_wizard_service_position_limited_sv_organisation.select_positions_text_no_abc' => 'Stellen w&auml;hlen',
            ...
            'tx_civserv_wizard_service_position_limited_sv_organisation.OK_Button' => 'OK',
			'tx_civserv_wizard_service_position_limited_sv_organisation.warning_org' => 'Bitte verkn&uuml;pfen Sie diese Dienstleistung zun&auml;chst mit einer Organisationseinheit!',
            'tx_civserv_wizard_service_position_limited_sv_organisation.Cancel_Button' => 'Abbrechen',
			'tx_civserv_wizard_service_position_limited_sv_organisation.no_position' => 'Keine Stellen verf&uuml;gbar in: ',
            'tx_civserv_wizard_service_position_limited_sv_organisation.warning_msg_1' => 'Bitte w&auml;hlen Sie mindestens eine Stelle aus!',
			...
			'tx_civserv_wizard_service_position_information.select_letter_text' => 'Geben Sie eine Stellenbezeichnung als Suchbegriff ein (Wortteil gen&uuml;gt)',
			'tx_civserv_wizard_service_position_information.select_positions_text_no_abc' => 'Stellen w&auml;hlen',
			...
			'tx_civserv_wizard_service_position_information.warning_msg_1' => 'Bitte w&auml;hlen Sie mindestens eine Position aus!',
			'tx_civserv_wizard_service_position_information.warning_msg_2' => 'FEHLER - Referenz auf das Hauptfenster nicht richtig gesetzt!',
				// LOCAL_LANG for class.tx_civserv_wizard_service_organisation.php
            'tx_civserv_wizard_service_organisation.title' => 'W&auml;hlen Sie die Organisationen',
            'tx_civserv_wizard_service_organisation.select_letter_text' => 'Anfangsbuchstaben der Organisation w&auml;hlen',
            'tx_civserv_wizard_service_organisation.select_organisations_text' => 'Organisationen w&auml;hlen mit Anfangsbuchstaben ',
			'tx_civserv_wizard_service_organisation.select_organisations_text_no_abc' => 'Organisationen w&auml;hlen',
            ...
            'tx_civserv_wizard_service_organisation.OK_Button' => 'OK',
			'tx_civserv_wizard_service_organisation.other' => ' | Ämterk&uuml;rzel',
            'tx_civserv_wizard_service_organisation.Cancel_Button' => 'Abbrechen',
            'tx_civserv_wizard_service_organisation.warning_msg_1' => 'Bitte w&auml;hlen Sie mindestens eine Organisation aus!',
            'tx_civserv_wizard_service_organisation.warning_msg_2' => 'FEHLER - Referenz auf das Hauptfenster nicht richtig gesetzt!',
				// LOCAL_LANG for class.tx_civserv_wizard_service_searchword.php
            'tx_civserv_wizard_service_searchword.title' => 'W&auml;hlen Sie die Suchworte',
            'tx_civserv_wizard_service_searchword.select_letter_text' => 'Anfangsbuchstaben der Suchworte w&auml;hlen',
            'tx_civserv_wizard_service_searchword.select_searchword_text' => 'Suchworte w&auml;hlen mit Anfangsbuchstaben ',
			'tx_civserv_wizard_service_searchword.select_searchword_text_no_abc' => 'Suchworte w&auml;hlen',
            ...
            'tx_civserv_wizard_service_searchword.warning_msg_1' => 'Bitte w&auml;hlen Sie mindestens ein Suchwort aus!',
            'tx_civserv_wizard_service_searchword.warning_msg_2' => 'FEHLER - Referenz auf das Hauptfenster nicht richtig gesetzt!',
				// LOCAL_LANG for class.tx_civserv_wizard_service_similar_services.php
            'tx_civserv_wizard_service_similar_services.title' => 'W&auml;hlen Sie die &auml;hnlichen Dienstleistungen',
            'tx_civserv_wizard_service_similar_services.select_category_text' => 'Dienstleistungskategorie w&auml;hlen',
            'tx_civserv_wizard_service_similar_services.select_service_text' => 'Dienstleistungen w&auml;hlen',
            'tx_civserv_wizard_service_similar_services.service_category_dummy' => 'Kategorie w&auml;hlen',
            ...
            'tx_civserv_wizard_service_similar_services.warning_msg_1' => 'Bitte w&auml;hlen Sie mindestens eine Dienstleistung aus!',
            'tx_civserv_wizard_service_similar_services.warning_msg_2' => 'FEHLER - Referenz auf das Hauptfenster nicht richtig gesetzt!',
				// LOCAL_LANG for class.tx_civserv_wizard_employee_position_room.php
			'tx_civserv_wizard_employee_position_room.title' => 'W&auml;hlen Sie den Raum in dem der Mitarbeiter sitzt',
			'tx_civserv_wizard_employee_position_room.select_letter_text' => 'W&auml;hlen Sie den Anfangsbuchstaben des Geb&auml;udes',
			'tx_civserv_wizard_employee_position_room.select_building_text_no_abc' => 'W&auml;hlen Sie ein Geb&auml;ude',
            'tx_civserv_wizard_employee_position_room.select_building_text' => 'W&auml;hlen Sie ein Geb&auml;ude mit dem Anfangsbuchstaben ',
            'tx_civserv_wizard_employee_position_room.select_floor_text' => 'W&auml;hlen Sie eine Etage',
			'tx_civserv_wizard_employee_position_room.select_room_text' => 'W&auml;hlen Sie den Raum',
            'tx_civserv_wizard_employee_position_room.building_dummy' => 'bitte w&auml;hlen Sie ein Geb&auml;ude',
			'tx_civserv_wizard_employee_position_room.floor_dummy' => 'bitte w&auml;hlen Sie eine Etage',
			'tx_civserv_wizard_employee_position_room.room_dummy' => 'bitte w&auml;hlen Sie den Raum',
			'tx_civserv_wizard_employee_position_room.no_room_on_this_floor' => 'bitte w&auml;hlen Sie eine andre Etage!',
            'tx_civserv_wizard_employee_position_room.OK_Button' => 'OK',
            'tx_civserv_wizard_employee_position_room.Cancel_Button' => 'Abbrechen',
            'tx_civserv_wizard_employee_position_room.warning_msg_1' => 'Bitte w&auml;hlen Sie einen Raum aus!',
