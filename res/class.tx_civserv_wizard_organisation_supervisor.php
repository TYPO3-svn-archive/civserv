	...
	function getSupervisors($letter)	{
		...
		if ($letter != "other" and $letter != "searchitem") {
			...
			$this->res = $GLOBALS['TYPO3_DB']->exec_SELECTquery(
				...
				'upper(left(em_name,1))=\''.$letter.'\' AND !deleted AND !hidden',	// AND title LIKE "%blabla%"', // WHERE...
				'', 										// GROUP BY...
				'em_name',   								// ORDER BY...
				'' 											// LIMIT to 10 rows, starting with number 5 (MySQL compat.)
				);
		...
		if ($letter == "other") {
			...
			$this->res = $GLOBALS['TYPO3_DB']->exec_SELECTquery(
				'*',			 							// SELECT ...
				'tx_civserv_employee',						// FROM ...
				'!(upper(left(em_name,1))=\'A\') AND !(upper(left(em_name,1))=\'B\') AND !(upper(left(em_name,1))=\'C\') AND !(upper(left(em_name,1))=\'D\') AND !(upper(left(em_name,1))=\'E\') AND !(upper(left(em_name,1))=\'F\') AND !(upper(left(em_name,1))=\'G\') AND !(upper(left(em_name,1))=\'H\') AND !(upper(left(em_name,1))=\'I\') AND !(upper(left(em_name,1))=\'J\') AND !(upper(left(em_name,1))=\'K\') AND !(upper(left(em_name,1))=\'L\') AND !(upper(left(em_name,1))=\'M\') AND !(upper(left(em_name,1))=\'N\') AND !(upper(left(em_name,1))=\'O\') AND !(upper(left(em_name,1))=\'P\') AND !(upper(left(em_name,1))=\'Q\') AND !(upper(left(em_name,1))=\'R\') AND !(upper(left(em_name,1))=\'S\') AND !(upper(left(em_name,1))=\'T\') AND !(upper(left(em_name,1))=\'U\') AND !(upper(left(em_name,1))=\'V\') AND !(upper(left(em_name,1))=\'W\') AND !(upper(left(em_name,1))=\'X\') AND !(upper(left(em_name,1))=\'Y\') AND !(upper(left(em_name,1))=\'Z\') AND !deleted AND !hidden',	// AND title LIKE "%blabla%"', // WHERE...
				'', 										// GROUP BY...
				'em_name',   								// ORDER BY...
				'' 											// LIMIT to 10 rows, starting with number 5 (MySQL compat.)
				);
		...
		if ($letter == "searchitem" AND $this->searchitem != "") {
				...
				'*',			 							// SELECT ...
				'tx_civserv_employee',						// FROM ...
				'em_name like \'%'.$this->searchitem.'%\' AND !deleted AND !hidden',	// AND title LIKE "%blabla%"', // WHERE...
				'', 										// GROUP BY...
				'em_name',   								// ORDER BY...
				'' 											// LIMIT to 10 rows, starting with number 5 (MySQL compat.)
				);
