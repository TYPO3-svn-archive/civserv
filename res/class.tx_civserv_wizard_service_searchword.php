	...
	function getSearchwords($letter)	{
		...
		if ($letter != "other" and $letter != "search") {
			...
			$this->res = $GLOBALS['TYPO3_DB']->exec_SELECTquery(
				...
				'upper(left(sw_search_word,1))=\''.$letter.'\' AND !deleted AND !hidden',	// AND title LIKE "%blabla%"', // WHERE...
				'', 										// GROUP BY...
		...
		if ($letter == "other") {
			...
			$this->res = $GLOBALS['TYPO3_DB']->exec_SELECTquery(
				'*',			 							// SELECT ...
				'tx_civserv_search_word',					// FROM ...
				'!(upper(left(sw_search_word,1))=\'A\') AND !(upper(left(sw_search_word,1))=\'B\') AND !(upper(left(sw_search_word,1))=\'C\') AND !(upper(left(sw_search_word,1))=\'D\') AND !(upper(left(sw_search_word,1))=\'E\') AND !(upper(left(sw_search_word,1))=\'F\') AND !(upper(left(sw_search_word,1))=\'G\') AND !(upper(left(sw_search_word,1))=\'H\') AND !(upper(left(sw_search_word,1))=\'I\') AND !(upper(left(sw_search_word,1))=\'J\') AND !(upper(left(sw_search_word,1))=\'K\') AND !(upper(left(sw_search_word,1))=\'L\') AND !(upper(left(sw_search_word,1))=\'M\') AND !(upper(left(sw_search_word,1))=\'N\') AND !(upper(left(sw_search_word,1))=\'O\') AND !(upper(left(sw_search_word,1))=\'P\') AND !(upper(left(sw_search_word,1))=\'Q\') AND !(upper(left(sw_search_word,1))=\'R\') AND !(upper(left(sw_search_word,1))=\'S\') AND !(upper(left(sw_search_word,1))=\'T\') AND !(upper(left(sw_search_word,1))=\'U\') AND !(upper(left(sw_search_word,1))=\'V\') AND !(upper(left(sw_search_word,1))=\'W\') AND !(upper(left(sw_search_word,1))=\'X\') AND !(upper(left(sw_search_word,1))=\'Y\') AND !(upper(left(sw_search_word,1))=\'Z\') AND !deleted AND !hidden',	// AND title LIKE "%blabla%"', // WHERE...
				'', 										// GROUP BY...
				'sw_search_word',   						// ORDER BY...
				'' 											// LIMIT to 10 rows, starting with number 5 (MySQL compat.)
				);
