...
$LOCAL_LANG = Array (
    "default" => Array (
		...
		"sv_region_checkbox.details" => "With activation of this checkbox an external service can be integrated with a link. An external service does not belong to the offer of the administration.",
	...
	"de" => Array (
		...
		"sv_region_checkbox.details" => "Durch Aktivieren dieser Checkbox kann eine externe Dienstleistung über einen Link eingebunden werden. Eine externe Dienstleistung gehört nicht zu dem Angebot der Verwaltung.",
