...
$LOCAL_LANG = Array (
	"default" => Array (
		"xyz.emailmessage.subject" => "External Service: '###service_name###'",
		"xyz.emailmessage.header" => "This E-Mail is automatically created by the O.S.I.R.I.S.-External-Service-Workflow! Please do NOT reply to this E-Mail!\n***********************************\n\nHello ###mandant_name###,\n",	
	...
	"de" => Array (
		"xyz.emailmessage.subject" => "Externe Dienstleistung: '###service_name###'",
		"xyz.emailmessage.header" => "Diese E-Mail wurde automatisch durch den O.S.I.R.I.S.-Externe-Dienstleistungen-Workflow generiert!\nBitte antworten Sie NICHT auf diese E-Mail!\n***********************************\n\nHallo ###mandant_name###,\n",	
