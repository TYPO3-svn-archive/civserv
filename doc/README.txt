...
MANUELLES SETUP:
Nach der Installation der Extension �ber den Extension Manager folgen Sie bitte der Setup-Anleitung im Manual um das Grundger�st f�r ein virtuelles Rathaus mit Seitenbaum und Frontend-Ausgabe aufzubauen.

DEMO:
Sie k�nnen eine Demo-Site mit Testdaten installieren, die MySQL-Dumps k�nnen Sie bei der citeq downloaden:
http://www4.citeq.de/osiris/doc/demo_site/ext_tables_static+adt_38x.sql.ATTENTION.tar.gz
http://www4.citeq.de/osiris/doc/demo_site/ext_tables_static+adt_40x.sql.ATTENTION.tar.gz
Dieser Datenbank Dump �berschreibt eine ggfs existierende Site: er ersetzt alle tx_civserv* Tabellen, sowie die Tabellen pages, be_groups und be_users aus Ihrer Datenbank!!!
Die Ressourcen f�r die Demo_Site befinden sich in 
http://www4.citeq.de/osiris/doc/demo_site/1110000.tar.gz. 
...
IN JEDEM FALL:
Nachdem Sie die 'civserv' Extension �ber den Extension Manager installiert haben, muessen Sie
