...
CREATE TABLE tx_civserv_service (
	...
	sv_similar_services_PLACEHOLDER tinytext NOT NULL,
	sv_form int(11) unsigned DEFAULT '0' NOT NULL,
	sv_form_PLACEHOLDER tinytext NOT NULL,
	sv_searchword int(11) unsigned DEFAULT '0' NOT NULL,
	sv_searchword_PLACEHOLDER tinytext NOT NULL,
	sv_position int(11) unsigned DEFAULT '0' NOT NULL,
	sv_position_PLACEHOLDER tinytext NOT NULL,
...
CREATE TABLE tx_civserv_building (
	...
	bl_floor_PLACEHOLDER tinytext NOT NULL,
